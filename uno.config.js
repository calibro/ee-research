...
const rules = [
	...
	[
		/^scrollbar-hide$/,
		([_]) => {
			return `.scrollbar-hide::-webkit-scrollbar{display:none} .scrollbar-hide{scrollbar-width:0px}`
		},
	],
	[
		/^scrollbar-default$/,
		([_]) => {
			return `.scrollbar-default::-webkit-scrollbar{display:block} .scrollbar-default{scrollbar-width:auto}`
		},
	],
]
